...
export const makeTheme = (h, dark) => {
  ...
  if (dark) {
    return {
      ...
      ink: c(79, 0.12), accent: c(72, 0.145), line: 'rgba(255,255,255,.09)', line2: 'rgba(255,255,255,.2)',
  ...
  return {
    ...
    ink: c(48, 0.12), accent: c(63, 0.15), line: c(48, 0.12, 0.14), line2: c(48, 0.12, 0.28),
